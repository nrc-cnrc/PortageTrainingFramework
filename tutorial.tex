...
\tip\margintip You can use \code{disown} to retroactively ``nohup'' a process:
 Ctrl-Z and \code{bg} put it in the background; \code{jobs}
tells you its job number, typically \code{1}; \code{disown \%1} disconnects it
from the shell, protecting it from hangup signals.\tipend
...
\begin{alltt}
   ...
   15M     models/portageLive/models/tm/cpt.merged.hmm3-kn3-zn.tm-train.fr2en.tppt
...
Resource summary for $PORTAGE/toy.experiment:
      ...
      tc:TIME-MEM                                             WALL TIME: 51s      CPU TIME: 23s        VSZ: 0.072G    RSS: 0.008G
         log.cpt.merged.hmm3-kn3-zn.tm-train.fr2en:TIME-MEM   WALL TIME: 24s      CPU TIME: 23s        VSZ: 0.042G    RSS: 0.007G
         log.cpt.merged.hmm3-kn3-zn.tm-train.fr2en.tppt:TIME-MEM WALL TIME: 15s   CPU TIME: 17s        VSZ: 0.042G    RSS: 0.007G
