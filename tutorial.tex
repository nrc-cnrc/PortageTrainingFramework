...
\begin{alltt}
   > \textbf{make ibm2_cpt}
   joint2cond_phrase_tables -prune1 100 -v -i -z -ibm 2 -1 fr -2 en \bs
      -s RFSmoother -s ZNSmoother -multipr fwd -o cpt.ibm2-rf-zn.train \bs
      -ibm_l2_given_l1 ibm2.train.en_given_fr.gz \bs
      -ibm_l1_given_l2 ibm2.train.fr_given_en.gz \bs
      -reduce-mem -no-sort jpt.ibm2.train.fr-en.gz \bs
...
\begin{small}
\begin{alltt}
   > \textbf{zgrep '| proposed regulations |' cpt.ibm2-rf-zn.train.fr2en.gz}
...
\begin{alltt}
   ...
   joint2cond_phrase_tables -prune1 100 -v -i -z -hmm -1 fr -2 en \bs
      -s RFSmoother -s ZNSmoother -multipr fwd -o cpt.hmm3-rf-zn.train  \bs
      -ibm_l2_given_l1 hmm3.train.en_given_fr.gz \bs
      -ibm_l1_given_l2 hmm3.train.fr_given_en.gz \bs
      -reduce-mem -no-sort jpt.hmm3.train.fr-en.gz \bs
...
\begin{alltt}
   ...
   parallelize.pl -nolocal -psub -1 -n 30 -np 30 -w 100000 \bs
      ...
      >& log.ldm.counts.hmm3
   zcat -f ldm.counts.ibm2.gz ldm.counts.hmm3.gz \bs
...
\begin{alltt}
   ...
   cat canoe.ini.template \bs
      | sed -e 's/<SL>/fr/g' \bs
           ...
           > tmp.canoe.ini
   WT=$(perl -e 'print 1; print ":1" foreach (2..`configtool nt tmp.canoe.ini`)'); \bs
   cat tmp.canoe.ini \bs
      | sed -e "s/^##mid##//" -e "s/<ENABLE_FTM>/$WT/" \bs
