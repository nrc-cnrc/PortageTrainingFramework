...
\begin{alltt}
   ...
   merge_multi_column_counts -fillup - hldm.ibm4.counts.gz hldm.hmm3.counts.gz hldm.ibm2.counts.gz \bs
...
is easy to read.  You will notice that there are two ``TranslationModel''
...
\begin{alltt}
   ...
   [ttable-multi-prob] 
      models/tm/cpt.PI-kn3-zn.hmm3.fr2en.gz
   [lex-dist-model-file] 
      models/ldm/hldm.ibm4+hmm3+ibm2.fr2en.gz
   [lmodel-file] 
      models/lm/lm-train_en-kn-5g.binlm.gz
   [weight-l] 1
