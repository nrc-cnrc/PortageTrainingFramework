...
\begin{small}
\begin{verbatim}
   > cp $PORTAGE/test-suite/tutorial-data/*.al \
        corpora/
   > wc corpora/*.al
...
\begin{verbatim}
   ...
   23M     models/portageLive/models/tm
   804K    models/portageLive/models/tc/tc-map.en.tppt
   1.1M    models/portageLive/models/tc/tc-lm.en.tplm
   1.9M    models/portageLive/models/tc
   1.4M    models/portageLive/models/lm/train_fr-kn-5g.tplm
   1.5M    models/portageLive/models/lm/train_en-kn-5g.tplm
   2.9M    models/portageLive/models/lm
   40M     models/portageLive/models
   40M     models/portageLive
\end{verbatim}
\end{small}
...
Resource summary for $PORTAGE/toy.experiment:
      log.ldm.counts.hmm3:TIME-MEM              WALL TIME: 31s      CPU TIME: 26s        VSZ: 0.088G   RSS: 0.009G
      log.ldm.counts.ibm2:TIME-MEM              WALL TIME: 11s      CPU TIME: 6s         VSZ: 0.049G   RSS: 0.006G
      log.ldm.hmm3+ibm2.fr2en:TIME-MEM          WALL TIME: 15s      CPU TIME: 12s        VSZ: 0.059G   RSS: 0.008G
      log.ldm.hmm3+ibm2.fr2en.tpldm:TIME-MEM    WALL TIME: 40s      CPU TIME: 37s        VSZ: 0.095G   RSS: 0.029G
   ldm:TIME-MEM                                 WALL TIME: 1m37s    CPU TIME: 1m21s      VSZ: 0.095G   RSS: 0.029G
      log.train_en-kn-5g.binlm:TIME-MEM         WALL TIME: 3s       CPU TIME: 2s         VSZ: 0.073G   RSS: 0.009G
      log.train_en-kn-5g.lm:TIME-MEM            WALL TIME: 2s       CPU TIME: 1s         VSZ: 0.068G   RSS: 0.015G
      log.train_en-kn-5g.tplm:TIME-MEM          WALL TIME: 19s      CPU TIME: 4s         VSZ: 0.048G   RSS: 0.008G
      log.train_fr-kn-5g.binlm:TIME-MEM         WALL TIME: 4s       CPU TIME: 3s         VSZ: 0.063G   RSS: 0.009G
      log.train_fr-kn-5g.lm:TIME-MEM            WALL TIME: 2s       CPU TIME: 1s         VSZ: 0.069G   RSS: 0.015G
      log.train_fr-kn-5g.tplm:TIME-MEM          WALL TIME: 19s      CPU TIME: 4s         VSZ: 0.062G   RSS: 0.009G
   lm:TIME-MEM                                  WALL TIME: 49s      CPU TIME: 15s        VSZ: 0.073G   RSS: 0.015G
      log.cpt.hmm3-rf-zn.train.fr2en:TIME-MEM   WALL TIME: 19s      CPU TIME: 21s        VSZ: 0.058G   RSS: 0.008G
      log.cpt.ibm2-rf-zn.train.fr2en:TIME-MEM   WALL TIME: 6s       CPU TIME: 6s         VSZ: 0.057G   RSS: 0.007G
      log.hmm3.train.en_given_fr:TIME-MEM       WALL TIME: 2m0s     CPU TIME: 3m19s      VSZ: 0.077G   RSS: 0.013G
      log.hmm3.train.fr_given_en:TIME-MEM       WALL TIME: 1m17s    CPU TIME: 2m42s      VSZ: 0.073G   RSS: 0.009G
      log.ibm1.train.en_given_fr:TIME-MEM       WALL TIME: 59s      CPU TIME: 42s        VSZ: 0.074G   RSS: 0.010G
      log.ibm1.train.fr_given_en:TIME-MEM       WALL TIME: 55s      CPU TIME: 42s        VSZ: 0.074G   RSS: 0.014G
      log.ibm2.train.en_given_fr:TIME-MEM       WALL TIME: 50s      CPU TIME: 33s        VSZ: 0.087G   RSS: 0.010G
      log.ibm2.train.fr_given_en:TIME-MEM       WALL TIME: 55s      CPU TIME: 34s        VSZ: 0.074G   RSS: 0.011G
      log.jpt.hmm3.train.fr-en:TIME-MEM         WALL TIME: 17s      CPU TIME: 30s        VSZ: 0.160G   RSS: 0.011G
      log.jpt.ibm2.train.fr-en:TIME-MEM         WALL TIME: 17s      CPU TIME: 12s        VSZ: 0.160G   RSS: 0.016G
   tm:TIME-MEM                                  WALL TIME: 7m55s    CPU TIME: 9m41s      VSZ: 0.160G   RSS: 0.016G
      log.train_en-kn-3g.binlm:TIME-MEM         WALL TIME: 3s       CPU TIME: 1s         VSZ: 0.063G   RSS: 0.009G
      log.train_en-kn-3g.lm:TIME-MEM            WALL TIME: 15s      CPU TIME: 0s         VSZ: 0.065G   RSS: 0.012G
      log.train_en-kn-3g.tplm:TIME-MEM          WALL TIME: 13s      CPU TIME: 2s         VSZ: 0.048G   RSS: 0.007G
      log.train_en.map:TIME-MEM                 WALL TIME: 0s       CPU TIME: 0s         VSZ: 0.054G   RSS: 0.010G
      log.train_en.map.tppt:TIME-MEM            WALL TIME: 11s      CPU TIME: 0s         VSZ: 0.062G   RSS: 0.008G
   tc:TIME-MEM                                  WALL TIME: 42s      CPU TIME: 3s         VSZ: 0.065G   RSS: 0.012G
      log.canoe.ini.cow:TIME-MEM                WALL TIME: 21m6s    CPU TIME: 58m35s     VSZ: 0.551G   RSS: 0.482G
      log.cpt.fr2en:TIME-MEM                    WALL TIME: 1m4s     CPU TIME: 1m3s       VSZ: 0.083G   RSS: 0.014G
      log.one.cpt.fr2en:TIME-MEM                WALL TIME: 29s      CPU TIME: 7s         VSZ: 0.062G   RSS: 0.008G
   decode:TIME-MEM                              WALL TIME: 22m39s   CPU TIME: 59m45s     VSZ: 0.551G   RSS: 0.482G
      log.rescore-model:TIME-MEM                WALL TIME: 3m52s    CPU TIME: 12m57s     VSZ: 0.081G   RSS: 0.018G
   rescore:TIME-MEM                             WALL TIME: 3m52s    CPU TIME: 12m57s     VSZ: 0.081G   RSS: 0.018G
      log.ce_model.cem:TIME-MEM                 WALL TIME: 26s      CPU TIME: 1m4s       VSZ: 0.086G   RSS: 0.009G
   confidence:TIME-MEM                          WALL TIME: 26s      CPU TIME: 1m4s       VSZ: 0.086G   RSS: 0.009G
      log.test.ce:TIME-MEM                      WALL TIME: 26s      CPU TIME: 1m6s       VSZ: 0.092G   RSS: 0.010G
      log.test.rat:TIME-MEM                     WALL TIME: 10s      CPU TIME: 7s         VSZ: 0.073G   RSS: 0.010G
      log.test.rat.tc:TIME-MEM                  WALL TIME: 1s       CPU TIME: 0s         VSZ: 0.050G   RSS: 0.009G
   translate:TIME-MEM                           WALL TIME: 37s      CPU TIME: 1m13s      VSZ: 0.092G   RSS: 0.010G
TIME-MEM                                        WALL TIME: 38m37s   CPU TIME: 1h26m19s   VSZ: 0.551G   RSS: 0.482G
\end{verbatim}
\end{footnotesize}
\end{sidewaysfigure}
...
\begin{verbatim}
   ...
   11M     models/decode/cpt.fr2en.gz
   14M     models/decode/one.cpt.fr2en.gz
   9.8M    translate
   119M    total
