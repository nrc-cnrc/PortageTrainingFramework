...
This tutorial start from sentence-aligned plain text, as you would get from our
\code{tmx-prepro} module extracting data from a TMX file.
...
tokenized \code{*.al*} files, but changed it to reflect the more common
