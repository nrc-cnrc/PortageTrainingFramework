...
\code{utf8\_casemap} being used.  If you installed \PS without ICU, you
...
\begin{alltt}
   ...
   projets de règlement ||| proposed regulations ||| 0.55 0.0016 0.84 0.026 a=0_-_1
   règlements proposés ||| proposed regulations ||| 0.017 0.018 0.05 0.42 a=1_0
\end{alltt}
\end{small}
