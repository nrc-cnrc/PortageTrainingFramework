...
\item to use IRSLTM, comment out the \texttt{LM\_TOOLKIT\_SRI} variable and set
the \texttt{IRSTLM} variable to the location where IRSTLM is installed;
\item to use neither, comment out both \texttt{LM\_TOOLKIT\_SRI} and
\texttt{IRSTLM}.
\end{itemize}
\end{itemize}
...
We recommend you use SRILM (www.speech.sri.com/projects/srilm/) as your
